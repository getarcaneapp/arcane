...
<DrawerPrimitive.Portal {...portalProps}>
	...
	<DrawerPrimitive.Content
		...
		class={cn(
			'group/drawer-content text-foreground dark:bg-surface/10 fixed z-[var(--arcane-z-surface)] flex h-auto flex-col border-border/70 bg-white/10 backdrop-blur-md',
