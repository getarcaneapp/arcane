<script lang="ts" module>
	import type { Action, ArcaneButtonSize, ArcaneButtonTone } from '#lib/components/arcane-button/index.js';
...
<script lang="ts">
	...
	let {
		...
		onclick,
		onAction
	}: ImageCropperActionButtonProps & { action: Action; onAction: () => void } = $props();
</script>
