				...
				{:else}
					<div class="grid grid-cols-2 gap-4">
						<div class="flex flex-col">
							<span class="text-muted-foreground text-xs font-medium">Total Goroutines</span>
						...
						<div class="flex flex-col">
							<span class="text-muted-foreground text-xs font-medium">OS Threads</span>
							<div class="flex items-center gap-2">
					...
					<div class="mt-6 space-y-4">
						<div class="bg-secondary flex h-3 w-full overflow-hidden rounded-full">
				...
				{:else}
					<div class="grid grid-cols-2 gap-6">
						{#each memoryStats as item}
							<div class="border-primary/20 flex flex-col border-l-2 pl-4">
	...
	<Card.Root>
		...
		<Card.Content class="py-4">
			...
			{:else}
				...
				<div class="text-muted-foreground mt-6 flex items-center gap-2 border-t pt-4 text-xs">
