...
<div class="container mx-auto flex min-h-screen max-w-full flex-col space-y-6 overflow-hidden p-2 sm:p-6">
	...
	<div class="mb-10 grid min-h-0 flex-1 grid-cols-1 gap-6 lg:grid-cols-5 lg:items-stretch">
