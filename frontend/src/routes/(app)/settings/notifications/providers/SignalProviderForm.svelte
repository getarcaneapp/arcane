...
>
	...
	<div class="space-y-4">
		<div class="rounded-lg border p-4">
			<h4 class="text-sm font-medium mb-3">{m.notifications_signal_auth_section()}</h4>
			<p class="text-muted-foreground text-sm mb-4">{m.notifications_signal_auth_help()}</p>
	...
	{#if onTest}
		<div class="pt-2">
			<ArcaneButton
				...
				loading={isTesting}
				icon={SendEmailIcon}
				customLabel={m.notifications_signal_test_button()}
			/>
		</div>
	{/if}
</ProviderFormWrapper>
