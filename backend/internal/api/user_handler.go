...
func (h *UserHandler) CreateUser(c *gin.Context) {
	...
	out, err := dto.MapOne[*models.User, user.Response](createdUser)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{
			"success": false,
...
func (h *UserHandler) GetUser(c *gin.Context) {
	...
	out, err := dto.MapOne[*models.User, user.Response](userModel)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{
			"success": false,
			"data":    gin.H{"error": (&common.UserMappingError{Err: err}).Error()},
...
func (h *UserHandler) UpdateUser(c *gin.Context) {
	...
	out, err := dto.MapOne[*models.User, user.Response](updatedUser)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{
			"success": false,
			"data":    gin.H{"error": (&common.UserMappingError{Err: err}).Error()},
