...
func (s *LifecycleService) resolveRunnerImageInternal(ctx context.Context, sync *GitOpsSync) string {
	if sync != nil {
...
func (s *LifecycleService) resolveTimeoutInternal(ctx context.Context, perSyncTimeoutSec int) time.Duration {
	...
	maxTimeoutSec := s.settingsService.GetIntSetting(ctx, "lifecycleMaxTimeoutSec", DefaultMaxTimeoutSec)
...
func buildLifecycleMountsInternal(workspace *mounttypes.Mount, extras []lifecycletype.ExtraMount) []mounttypes.Mount {
