...
import (
	...
	pkgscheduler "github.com/getarcaneapp/arcane/backend/v2/pkg/scheduler"
)

func registerJobs(appCtx context.Context, newScheduler *pkgscheduler.JobScheduler, appServices *di.Services, appConfig *config.Config) {
...
func registerDynamicJobs(appCtx context.Context, newScheduler *pkgscheduler.JobScheduler, appServices *di.Services, appConfig *config.Config) {
...
func setupSettingsCallbacks(lifecycleCtx context.Context, appServices *di.Services, appConfig *config.Config, newScheduler *pkgscheduler.JobScheduler, jobs *di.Jobs) {
