...
const (
	...
	ActivityTypeContainerKill     ActivityType = "container_kill"
	ActivityTypeContainerPause    ActivityType = "container_pause"
	ActivityTypeContainerUnpause  ActivityType = "container_unpause"
