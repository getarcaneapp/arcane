...
// ToDTO converts a stored destination into its credential-redacted API representation.
...
// ToSync converts a stored destination and decrypted secret into an agent sync item.
