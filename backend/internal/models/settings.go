...
type Settings struct {
	...
	AllowedCustomFilePaths    SettingVariable `key:"allowedCustomFilePaths,envOverride" meta:"label=Allowed Custom File Paths;type=text;keywords=custom,files,paths,allowed,external,directories,absolute;category=general;description=Comma-separated list of absolute paths where custom files can be located outside the project directory"`
