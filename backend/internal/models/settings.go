...
type Settings struct {
	...
	AutoUpdateWindowInterval     SettingVariable `key:"autoUpdateWindowInterval" meta:"label=Auto Update Window Interval;type=cron;keywords=auto,update,window,interval,frequency,cron,schedule;category=internal;description=How often to check for updates while within the time window (cron expression)"`
