...
type Settings struct {
	...
	UseComposeUpdate             SettingVariable `key:"useComposeUpdate" meta:"label=Use Docker Compose for Updates;type=boolean;keywords=compose,docker-compose,update,deployment,method;category=internal;description=Use docker compose pull/down/up for updates instead of individual container restart"`
