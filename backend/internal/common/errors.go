...
var (
	...
	ErrVolumeFileConflict                      = Classify(ErrConflict, errors.Sentinel("Volume files changed; refresh the workspace and try again"))
	ErrVolumeFileForbidden                     = Classify(ErrForbidden, errors.Sentinel("Forbidden volume file path"))
	ErrVolumeFileBadRequest                    = Classify(ErrBadRequest, errors.Sentinel("Invalid volume file request"))
	ErrVolumeFileNotFound                      = Classify(ErrNotFound, errors.Sentinel("Volume file not found"))
