...
func registerHandlersInternal(api huma.API, deps HandlerDeps, handlerAppCtx handlers.ActivityAppContext, cfg *config.Config) {
	...
	handlers.RegisterProjects(api, deps.Project, deps.Activity, handlerAppCtx, cfg)
	...
	handlers.RegisterVolumes(api, deps.Docker, deps.Volume, deps.Activity, handlerAppCtx, cfg)
