...
const file_tunnel_v1_tunnel_proto_rawDesc = "" +
	"\n" +
	"\x16tunnel/v1/tunnel.proto\x12\ttunnel.v1\"\xb4\x03\n" +
	"\fAgentMessage\x12>\n" +
	...
	"\bregister\x18\a \x01(\v2\x1a.tunnel.v1.RegisterRequestH\x00R\bregisterB\t\n" +
	"\apayload\"\x8c\x03\n" +
	...
	"\tstream_id\x18\x01 \x01(\tR\bstreamId2R\n" +
	"\rTunnelService\x12A\n" +
	"\aConnect\x12\x17.tunnel.v1.AgentMessage\x1a\x19.tunnel.v1.ManagerMessage(\x010\x01BAZ?github.com/getarcaneapp/arcane/backend/proto/tunnel/v1;tunnelpbb\x06proto3"
...
var file_tunnel_v1_tunnel_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_tunnel_v1_tunnel_proto_goTypes = []any{
	...
	nil,                      // 13: tunnel.v1.HttpRequest.HeadersEntry
	nil,                      // 14: tunnel.v1.HttpResponse.HeadersEntry
	nil,                      // 15: tunnel.v1.WebSocketStart.HeadersEntry
}
var file_tunnel_v1_tunnel_proto_depIdxs = []int32{
	...
	4,  // 7: tunnel.v1.ManagerMessage.http_request:type_name -> tunnel.v1.HttpRequest
	9,  // 8: tunnel.v1.ManagerMessage.heartbeat_pong:type_name -> tunnel.v1.HeartbeatPong
	10, // 9: tunnel.v1.ManagerMessage.ws_start:type_name -> tunnel.v1.WebSocketStart
	11, // 10: tunnel.v1.ManagerMessage.ws_data:type_name -> tunnel.v1.WebSocketData
	12, // 11: tunnel.v1.ManagerMessage.ws_close:type_name -> tunnel.v1.WebSocketClose
	3,  // 12: tunnel.v1.ManagerMessage.register_response:type_name -> tunnel.v1.RegisterResponse
	13, // 13: tunnel.v1.HttpRequest.headers:type_name -> tunnel.v1.HttpRequest.HeadersEntry
	14, // 14: tunnel.v1.HttpResponse.headers:type_name -> tunnel.v1.HttpResponse.HeadersEntry
	15, // 15: tunnel.v1.WebSocketStart.headers:type_name -> tunnel.v1.WebSocketStart.HeadersEntry
	0,  // 16: tunnel.v1.TunnelService.Connect:input_type -> tunnel.v1.AgentMessage
	1,  // 17: tunnel.v1.TunnelService.Connect:output_type -> tunnel.v1.ManagerMessage
