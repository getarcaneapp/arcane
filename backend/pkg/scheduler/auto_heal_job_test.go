...
func TestAutoHeal_Run_UsesBoundedConcurrency(t *testing.T) {
	...
	job := NewAutoHealJob(nil, settingsSvc, nil, nil)
	job.getDockerClient = func() (client.APIClient, error) { return nil, nil }
	job.listContainers = func(ctx context.Context, dockerClient client.APIClient) ([]container.Summary, error) {
	...
	job.inspectContainer = func(ctx context.Context, dockerClient client.APIClient, containerID string) (container.InspectResponse, error) {
	...
	job.restartContainer = func(ctx context.Context, dockerClient client.APIClient, containerID string) error {
