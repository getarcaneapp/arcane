...
func TestResolveEdgeCommandName(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "volume workspace list", method: "GET", path: "/api/environments/0/volumes/data/files", command: "volume.workspace.list", shouldHit: true},
		{name: "volume workspace read file", method: "GET", path: "/api/environments/0/volumes/data/file?relativePath=notes/readme.txt", command: "volume.workspace.read_file", shouldHit: true},
		{name: "volume workspace update", method: "PUT", path: "/api/environments/0/volumes/data/files", command: "volume.workspace.update", shouldHit: true},
