...
var commandRoutes = []commandRoute{
	...
	{Method: http.MethodGet, PathPattern: "/api/environments/{id}/volumes/{volumeName}/files", CommandName: "volume.workspace.list"},
	{Method: http.MethodGet, PathPattern: "/api/environments/{id}/volumes/{volumeName}/file", CommandName: "volume.workspace.read_file"},
	{Method: http.MethodPut, PathPattern: "/api/environments/{id}/volumes/{volumeName}/files", CommandName: "volume.workspace.update"},
