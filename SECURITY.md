...
> [!IMPORTANT]
> If you are using AI to submit vulnerability, please follow the rules documented in [AI_POLICY.MD](https://github.com/getarcaneapp/arcane/blob/main/AI_POLICY.md).  CVE farming and other low-effort submissions are disrespectful and puts the burden of validation on the volunteer maintainers of this project.  AI-assisted security research is welcome, but submissions MUST be validated and reproducable by a human.
