...
> [!IMPORTANT]
> AI-assisted security research is welcome, but submissions MUST be validated and reproducible by a human.  If you are using AI to submit a vulnerability, please follow the rules documented in [AI_POLICY.md](https://github.com/getarcaneapp/arcane/blob/main/AI_POLICY.md).  CVE farming and other low-effort submissions are disrespectful and put the burden of validation on the volunteer maintainers of this project.
