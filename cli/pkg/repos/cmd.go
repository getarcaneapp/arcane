...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return cmdutil.RunList(cmd, c, cmdutil.ListSpec[gitops.GitRepository]{
			...
			Endpoint: types.Endpoints.GitRepositories(),
...
var createCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[gitops.GitRepository](cmd.Context(), types.Endpoints.GitRepositories(), req)
		if err != nil {
...
var testCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return cmdutil.RunPostAction[base.MessageResponse](cmd, c, cmdutil.PostActionSpec{
			Path:           types.Endpoints.GitRepositoryTest(resolved.ID),
...
var branchesCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[gitops.BranchesResponse](cmd.Context(), types.Endpoints.GitRepositoryBranches(resolved.ID))
		if err != nil {
...
var repoRef = cmdutil.ResourceRef[gitops.GitRepository, gitops.GitRepository]{
	...
	GetPath:  func(_ string, identifier string) string { return types.Endpoints.GitRepository(identifier) },
	ListPath: func(string) string { return types.Endpoints.GitRepositories() },
	Matches:  repoMatches,
