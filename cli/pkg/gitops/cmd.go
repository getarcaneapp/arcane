...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return cmdutil.RunList(cmd, c, cmdutil.ListSpec[gitops.GitOpsSync]{
			...
			Endpoint: types.Endpoints.GitOpsSyncs(c.EnvID()),
...
var createCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[gitops.GitOpsSync](cmd.Context(), types.Endpoints.GitOpsSyncs(c.EnvID()), req)
		if err != nil {
...
var getCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if !complete {
			result, err := c.GetJSON[gitops.GitOpsSync](cmd.Context(), types.Endpoints.GitOpsSync(c.EnvID(), resolved.ID))
			if err != nil {
...
var statusCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[gitops.SyncStatus](cmd.Context(), types.Endpoints.GitOpsSyncStatus(c.EnvID(), resolved.ID))
		if err != nil {
...
var syncCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[gitops.SyncResult](cmd.Context(), types.Endpoints.GitOpsSyncTrigger(c.EnvID(), resolved.ID), nil)
		if err != nil {
...
var importCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// in an array.
		result, err := c.PostJSON[gitops.ImportGitOpsSyncResponse](cmd.Context(), types.Endpoints.GitOpsSyncsImport(c.EnvID()), []gitops.ImportGitOpsSyncRequest{req})
		if err != nil {
...
var gitopsSyncRef = cmdutil.ResourceRef[gitops.GitOpsSync, gitops.GitOpsSync]{
	...
	GetPath:  types.Endpoints.GitOpsSync,
	ListPath: types.Endpoints.GitOpsSyncs,
