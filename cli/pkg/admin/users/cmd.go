...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return cmdutil.RunList(cmd, c, cmdutil.ListSpec[user.User]{
			Resource: "users",
			Endpoint: types.Endpoints.Users(),
...
var createCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[user.User](cmd.Context(), types.Endpoints.Users(), req)
		if err != nil {
...
var getCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[user.User](cmd.Context(), types.Endpoints.User(args[0]))
		if err != nil {
...
var updateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PutJSON[user.User](cmd.Context(), types.Endpoints.User(args[0]), req)
		if err != nil {
