...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[[]roletypes.OidcRoleMapping](cmd.Context(), types.Endpoints.OidcRoleMappings())
		if err != nil {
...
var createCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[roletypes.OidcRoleMapping](cmd.Context(), types.Endpoints.OidcRoleMappings(), req)
		if err != nil {
