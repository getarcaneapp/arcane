...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return cmdutil.RunList(cmd, c, cmdutil.ListSpec[roletypes.Role]{
			Resource: "roles",
			Endpoint: types.Endpoints.Roles(),
...
var getCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[roletypes.Role](cmd.Context(), types.Endpoints.Role(args[0]))
		if err != nil {
...
var createCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[roletypes.Role](cmd.Context(), types.Endpoints.Roles(), req)
		if err != nil {
...
var permissionsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[roletypes.PermissionsManifest](cmd.Context(), types.Endpoints.RolesAvailablePermissions())
		if err != nil {
...
var assignmentsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[[]roletypes.RoleAssignment](cmd.Context(), types.Endpoints.UserRoleAssignments(args[0]))
		if err != nil {
...
var assignCmd = &cobra.Command{
  ...
  arcane admin roles assign u_123 --role ""    # clear all manual assignments`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PutJSON[[]roletypes.RoleAssignment](cmd.Context(), types.Endpoints.UserRoleAssignments(args[0]), req)
		if err != nil {
...
func fetchRoleInternal(cmd *cobra.Command, id string) (*roletypes.Role, error) {
	...
	result, err := c.GetJSON[roletypes.Role](cmd.Context(), types.Endpoints.Role(id))
	if err != nil {
