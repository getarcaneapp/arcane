...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return cmdutil.RunList(cmd, c, cmdutil.ListSpec[apikey.ApiKey]{
			Resource: "API keys",
			Endpoint: types.Endpoints.ApiKeys(),
...
var createCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[apikey.ApiKeyCreatedDto](cmd.Context(), types.Endpoints.ApiKeys(), createReq)
		if err != nil {
...
var deleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.DeleteJSON[base.MessageResponse](cmd.Context(), types.Endpoints.ApiKey(args[0]))
		if err != nil {
...
var getCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[apikey.ApiKey](cmd.Context(), types.Endpoints.ApiKey(args[0]))
		if err != nil {
...
var updateCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PutJSON[apikey.ApiKey](cmd.Context(), types.Endpoints.ApiKey(args[0]), req)
		if err != nil {
