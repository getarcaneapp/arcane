...
var logoutCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[base.MessageResponse](cmd.Context(), types.Endpoints.AuthLogout(), nil)
		if err != nil {
...
var meCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[user.User](cmd.Context(), types.Endpoints.AuthMe())
		if err != nil {
...
var passwordCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[base.MessageResponse](cmd.Context(), types.Endpoints.AuthPassword(), reqBody)
		if err != nil {
...
var refreshCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[auth.TokenRefreshResponse](cmd.Context(), types.Endpoints.AuthRefresh(), reqBody)
		if err != nil {
...
var oidcStatusCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.DoJSON[oidcStatusResult](cmd.Context(), http.MethodGet, types.Endpoints.OIDCStatus(), nil)
		if err != nil {
