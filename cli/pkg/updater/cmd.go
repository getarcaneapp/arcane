...
var statusCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[updater.Status](cmd.Context(), types.Endpoints.UpdaterStatus(c.EnvID()))
		if err != nil {
...
var runCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[updater.Result](cmd.Context(), types.Endpoints.UpdaterRun(c.EnvID()), nil)
		if err != nil {
