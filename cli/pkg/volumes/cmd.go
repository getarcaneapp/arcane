...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return cmdutil.RunList(cmd, c, cmdutil.ListSpec[volume.Volume]{
			Resource: "volumes",
			Endpoint: types.Endpoints.Volumes(c.EnvID()),
...
var pruneCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return cmdutil.RunPostAction[any](cmd, c, cmdutil.PostActionSpec{
			Path:           types.Endpoints.VolumesPrune(c.EnvID()),
...
var usageCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.GetJSON[any](cmd.Context(), types.Endpoints.VolumeUsage(c.EnvID(), resolved.Name))
		if err != nil {
...
var createCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := c.PostJSON[volume.Volume](cmd.Context(), types.Endpoints.Volumes(c.EnvID()), req)
		if err != nil {
...
var volumeRef = cmdutil.ResourceRef[volume.Volume, volume.Volume]{
	...
	GetPath:  types.Endpoints.Volume,
	ListPath: types.Endpoints.Volumes,
