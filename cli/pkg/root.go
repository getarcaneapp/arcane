...
func init() {
	...
	rootCmd.AddCommand(configClient.Command)
	...
	rootCmd.AddCommand(containers.Command)
	rootCmd.AddCommand(images.Command)
	rootCmd.AddCommand(volumes.Command)
	rootCmd.AddCommand(networks.Command)
	rootCmd.AddCommand(projects.Command)
	rootCmd.AddCommand(environments.Command)
	rootCmd.AddCommand(registries.Command)
	rootCmd.AddCommand(repos.Command)
	rootCmd.AddCommand(templates.Command)
	rootCmd.AddCommand(settings.Command)
	rootCmd.AddCommand(jobs.Command)
	rootCmd.AddCommand(system.Command)
	rootCmd.AddCommand(updater.Command)
	rootCmd.AddCommand(selfupdate.Cmd)
	rootCmd.AddCommand(admin.Command)
	rootCmd.AddCommand(gitops.Command)
